...
### [67. Add Binary](https://leetcode.com/problems/add-binary/description/), [Solution](String/Add_Binary.py)
...
### [14. Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix/description/), [Solution](List/Longest_Common_Prefix.py)

简单，直接依次检查每个位置是否一样。

### [26. Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/description/), [Solution](List/Remove_Duplicates_from_Sorted_Array.py)

用 count 记录目前见到过的不同数字的个数，往后检查，碰到新的数就放到 nums 的 count 位置上，count 加 1。

### [27. Remove Element](https://leetcode.com/problems/remove-element/description/), [Solution](List/Remove_Element.py)

简单。不等于 val 的元素往前放，等于的不管就行了。

### [36. Valid Sudoku](https://leetcode.com/problems/valid-sudoku/description/), [Solution](List/Valid_Sudoku.py)
...
### [151. Reverse Words in a String](https://leetcode.com/problems/reverse-words-in-a-string/description/), [Solution](List/Reverse_Words_in_a_String.py)
...
### [165. Compare Version Numbers](https://leetcode.com/problems/compare-version-numbers/description/), [Solution](List/Compare_Version_Numbers.py)
...
### [283. Move Zeroes](https://leetcode.com/problems/move-zeroes/description/), [Solution](List/Move_Zeroes.py)
...
### [1275. Find Winner on a Tic Tac Toe Game](https://leetcode.com/problems/find-winner-on-a-tic-tac-toe-game/description/), [Solution](List/Find_Winner_on_a_Tic_Tac_Toe_Game.py)
...
### [2397. Maximum Rows Covered by Columns](https://leetcode.com/problems/maximum-rows-covered-by-columns/description/), [Solution](List/Maximum_Rows_Covered_by_Columns.py)
...
### [49. Group Anagrams](https://leetcode.com/problems/group-anagrams/description/), [Solution](Hashmap/Group_Anagrams.py)
...
### [383. Ransom Note](https://leetcode.com/problems/ransom-note/description/), [Solution](Hashmap/Ransom_Note.py)
...
### [2023. Number of Pairs of Strings With Concatenation Equal to Target](https://leetcode.com/problems/number-of-pairs-of-strings-with-concatenation-equal-to-target/description/), [Solution](Hashmap/Number_of_Pairs_of_Strings_With_Concatenation_Equal_to_Target.py)
...
### [21. Merge Two Sorted Lists](https://leetcode.com/problems/merge-two-sorted-lists/description/), [Solution](LinkedList/Merge_Two_Sorted_Lists.py)
...
### [206. Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/description/), [Solution](LinkedList/Reverse_Linked_List.py)
...
### [104. Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/description/), [Solution](Tree/Maximum_Depth_of_Binary_Tree.py)
...
### [257. Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/description/), [Solution](Tree/Binary_Tree_Paths.py)
...
### [22. Generate Parentheses](https://leetcode.com/problems/generate-parentheses/description/), [Solution](Math/Generate_Parentheses.py)

只要(的个数大于)的个数就可以在后面加)。只要(的个数不超过总括号的个数一半就可以在后面加(。就根据这个规则对 queue 里的每个组合继续往后加括号就行了。

### [48. Rotate Image](https://leetcode.com/problems/rotate-image/description/), [Solution](Math/Rotate_Image.py)
...
### [54. Spiral Matrix](https://leetcode.com/problems/spiral-matrix/description/), [Solution](Math/Spiral_Matrix.py)

建立四个方向，每一步把当前位置加入 visited 并构建下一步位置，如果下一步已经在 visited 里面就换到下一个方向并重新构建下一步的位置。重复直到 visited 元素等于 matrix 元素个数。

### [118. Pascal's Triangle](https://leetcode.com/problems/pascal's-triangle/description/), [Solution](Math/Pascal's_Triangle.py)

简单，初始化 n 等于 1 和 2 的情况，然后每一行根据前一行来生成。

### [149. Max Points on a Line](https://leetcode.com/problems/max-points-on-a-line/description/), [Solution](Math/Max_Points_on_a_Line.py)

以每个点为中心，计算他到其他所有点的向量的方向，方向一样就说明他们在一条直线上。用 map 记录每个方向的 count。这样得到通过这一个点的所有可能直线上的最多点数。对所有点重复，得到通过所有点的可能直线中的最大点数。

### [190. Reverse Bits](https://leetcode.com/problems/reverse-bits/description/), [Solution](Math/Reverse_Bits.py)
...
### [69. Sqrt(x)](<https://leetcode.com/problems/sqrt(x)/description/>), [Solution](<BinarySearch/Sqrt(x).py>)
...
### [240. Search a 2D Matrix II](https://leetcode.com/problems/search-a-2d-matrix-ii/description/), [Solution](BinarySearch/Search_a_2D_Matrix_II.py)
...
### [1146. Snapshot Array](https://leetcode.com/problems/snapshot-array/description/), [Solution](BinarySearch/Snapshot_Array.py)
...
### [28. Find the Index of the First Occurrence in a String](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/description/), [Solution](TwoPointer/Find_the_Index_of_the_First_Occurrence_in_a_String.py)
...
### [10. Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/description/), [Solution](DP/Regular_Expression_Matching.py)
...
### [53. Maximum Subarray](https://leetcode.com/problems/maximum-subarray/description/), [Solution](DP/Maximum_Subarray.py)
...
### [91. Decode Ways](https://leetcode.com/problems/decode-ways/description/), [Solution](DP/Decode_Ways.py)
...
### [221. Maximal Square](https://leetcode.com/problems/maximal-square/description/), [Solution](DP/Maximal_Square.py)
...
### [55. Jump Game](https://leetcode.com/problems/jump-game/description/), [Solution](Greedy/Jump_Game.py)
...
### [284. Peeking Iterator](https://leetcode.com/problems/peeking-iterator/description/), [Solution](OOD/Peeking_Iterator.py)
...
### [1242. Web Crawler Multithreaded](https://leetcode.com/problems/web-crawler-multithreaded/description/), [Solution](OOD/Web_Crawler_Multithreaded.py)
